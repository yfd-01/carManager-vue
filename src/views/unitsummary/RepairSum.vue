<template>
  <div class="app-container">
    <el-page-header
      ...
      @back="goBack"
    />
    <el-page-header v-else icon="house" title="维修统计" />
    <div
      class="main-header"
    ...
    >
      <div class="main-header-content">
        ...
        <CarChoice :getCarId="getCarId" :selectedUnitId="selectedUnitId" style="min-width:120px;"/>
      </div>
      <div class="main-header-content">
        <el-date-picker
          v-model="TimeFilter"
    ...
    <div class="tableWrap" ref="tableWrap">
      ...
      >
        <el-table-column type="index" prop="type" label="序号" width="60px" show-overflow-tooltip/>
        <el-table-column prop="appPerson" label="申请人" width="90px" show-overflow-tooltip/>
        <el-table-column prop="palteNumber" label="车牌号" width="120px" show-overflow-tooltip/>
        <el-table-column
          prop="appEnd"
          label="完成时间"
        ...
        <el-table-column
          ...
          width="120px"
        />
        <el-table-column prop="rpCost" label="消费金额(元)" width="120px" show-overflow-tooltip/>
        <el-table-column prop="rpMemo" label="备注" show-overflow-tooltip />
        <el-table-column label="操作" align="center" width="80px" show-overflow-tooltip>
      ...
      if (!isExport) {
        this.list = res.data.map((app) => {
          return {
            ...
            rpItem: app.data.rp_item,
            rpAddr: app.data.rp_addr,
            rpMemo: app.data.rp_memo,
            rpCost: app.data.rp_cost,
          };
        });
