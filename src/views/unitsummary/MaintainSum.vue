<template>
  <div class="app-container">
    <el-page-header
      ...
      @back="goBack"
    />
    <el-page-header v-else icon="house" title="保养统计" />
    <div
      class="main-header"
      ...
      >
        ...
        >
          ...
          <el-table-column
            ...
            width="120px"
          />
          <el-table-column prop="mtCost" label="消费金额(元)" show-overflow-tooltip width="120px" />
          <el-table-column prop="mtMemo" label="备注" show-overflow-tooltip />
      ...
      if (!isExport) {
        this.list = res.data.map((app) => {
          return {
            ...
            mtItem: app.data.mt_item,
            mtAddr: app.data.mt_addr,
            mtMemo: app.data.mt_memo,
            mtCost: app.data.mt_cost,
          };
        });
